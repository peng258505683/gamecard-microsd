...
static SceIoDevice uma_ux0_dev = { "uma0:", "exfatux0", "sdstor0:gcd-lp-ign-entire", "sdstor0:gcd-lp-ign-entire", MOUNT_POINT_ID };
static SceIoDevice uma_uma0_dev = { "ux0:", "exfatuma0", "sdstor0:xmc-lp-ign-userext", "sdstor0:xmc-lp-ign-userext", MOUNT_POINT_ID2 };

static SceIoDevice uma_ux0_dev2 = { "ux0:", "exfatux0", "sdstor0:gcd-lp-ign-entire", "sdstor0:gcd-lp-ign-entire", MOUNT_POINT_ID2 };
static SceIoDevice uma_uma0_dev2 = { "uma0:", "exfatuma0", "sdstor0:xmc-lp-ign-userext", "sdstor0:xmc-lp-ign-userext", MOUNT_POINT_ID };
...
int shellKernelIsUx0Redirected() {
     if(checkFileExist("sdstor0:xmc-lp-ign-userext")) { //Memory Card 原装卡
	...
	if (mount->dev == &uma_ux0_dev2 && mount->dev2 == &uma_ux0_dev2) {
		return 1;
	}
     }
	return 0;
...
int shellKernelRedirectUx0() {
	...
	mount->dev = &uma_ux0_dev2;
	mount->dev2 = &uma_ux0_dev2;
     }
	return 0;
}
int shellKernelRedirectUma0() {
	...
	if (mount->dev != &uma_uma0_dev2 && mount->dev2 != &uma_uma0_dev2) {
		ori_dev = mount->dev;
		ori_dev2 = mount->dev2;
	}

	mount->dev = &uma_uma0_dev2;
	mount->dev2 = &uma_uma0_dev2;
     }
	return 0;
}
...
int redirect_ux0() {
	...
	switch (info.module_nid) {
	   ...
	   shellKernelRedirectUma0();
        ...
        } else if (checkFileExist("sdstor0:gcd-lp-ign-entire")) { //SD2Vita TF卡套
	   shellKernelRedirectUx0();
	   io_remount(MOUNT_POINT_ID2);
	   shellKernelRedirectUma0();
           io_mount(MOUNT_POINT_ID);
           io_mount(MOUNT_POINT_ID3);
       }
